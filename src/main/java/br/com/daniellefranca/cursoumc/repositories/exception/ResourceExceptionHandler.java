...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> dataInregrity(DataIntegrityException e, HttpServletRequest request){
	...
	public ResponseEntity<StandardError> validation(MethodArgumentNotValidException e, HttpServletRequest request){
		...
		for (FieldError fieldErros : e.getBindingResult().getFieldErrors()) {
			validationError.addList(fieldErros.getField(), fieldErros.getDefaultMessage());
